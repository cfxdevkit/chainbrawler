...
import { OperationState, CharacterData } from "@chainbrawler/core";
...
export function StatusDisplay({ statusMessage, isLoading, operation, character }: StatusDisplayProps) {
  return (
