      ...
      {claims && (
        <div className="claims-content">
          <div className="claims-summary">
            ...
            <p><strong>Total Claimable:</strong> {claims.totalClaimable.toString()} ETH</p>
            <p><strong>Available Rewards:</strong> {claims.available.length}</p>
          </div>
              ...
              {claims.available.map((reward: any, index: number) => (
                <div key={index} className="claim-item">
                  <div className="claim-info">
                    ...
                    <p><strong>Amount:</strong> {reward.amount.toString()} ETH</p>
                    <p><strong>Type:</strong> {reward.type}</p>
                    {reward.epoch && <p><strong>Epoch:</strong> {reward.epoch}</p>}
                  </div>
