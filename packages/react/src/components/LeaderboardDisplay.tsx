      ...
      {leaderboard && (
        <div className="leaderboard-content">
          ...
          <div className="player-stats">
            <h4>Your Stats</h4>
            <p><strong>Rank:</strong> #{leaderboard.playerRank.toString()}</p>
            <p><strong>Score:</strong> {leaderboard.playerScore.toString()}</p>
            <p><strong>Total Players:</strong> {leaderboard.totalPlayers.toString()}</p>
          </div>
