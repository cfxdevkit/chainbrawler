...
import { IconAlertTriangle, IconUserPlus, IconSwords, IconCoins, IconTrophy, IconGift, IconHistory } from '@tabler/icons-react'
...
export function GamePage() {
  ...
  const handleClaimPrize = async (epoch: bigint, index: bigint, amount: bigint, proof: string[]) => {
    try {
  ...
  return (
    <>
          ...
          <Stack gap="lg">
            ...
            {isLoading ? (
              <GameCard variant="elevated">
                <Stack gap="xl" align="center">
                  <Stack align="center" gap="md">
                    <ThemeIcon size={80} variant="gradient" gradient={{ from: 'blue', to: 'cyan', deg: 45 }}>
                      <IconSwords size={40} />
                    </ThemeIcon>
              ...
              <GameCard variant="elevated">
                <Stack gap="xl" align="center">
                  <Stack align="center" gap="md">
                    <ThemeIcon size={80} variant="gradient" gradient={{ from: 'violet', to: 'blue', deg: 45 }}>
                    ...
                    <Text size="lg" c="dimmed" ta="center" maw={600}>
                      ...
                      Choose your class wisely - it will determine your fighting style and abilities!
                    </Text>
                  </Stack>
                ...
                <GameCard variant="glass">
                  <Stack gap="md">
                    <Group gap="xs">
                      ...
                      <Text size="lg" fw={700} c="white">Getting Started</Text>
                    </Group>
                    <Text size="sm" c="dimmed" style={{ lineHeight: 1.6 }}>
                      🎯 <Text component="span" fw={600} c="white">Choose your battles wisely:</Text> Start with low-level enemies to gain experience and equipment.
                      <br />
                      ❤️ <Text component="span" fw={600} c="white">Manage your health:</Text> Use the heal action when your health is low, or resurrect if you die.
                      <br />
                      ⚔️ <Text component="span" fw={600} c="white">Combat strategy:</Text> Higher level enemies give more XP but are much more dangerous.
                      <br />
                      🏆 <Text component="span" fw={600} c="white">Progress your character:</Text> Gain experience, level up, and find better equipment to face stronger foes.
                    </Text>
                  </Stack>
                </GameCard>
              )}
      ...
      <TransactionModal
        ...
        canClose={operationStatus?.status === 'completed' || operationStatus?.status === 'error' || operationStatus?.status === 'failed'}
      />
    </>
  )
}