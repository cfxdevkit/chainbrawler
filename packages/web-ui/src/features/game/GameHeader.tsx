    ...
    >
      <Container size="xl" h="100%">
        <Group h="100%" justify="space-between">
          ...
          <Group>
            <ThemeIcon size="xl" variant="gradient" gradient={{ from: 'violet', to: 'blue', deg: 45 }}>
              <IconSwords size={28} />
            </ThemeIcon>
            <Stack gap={0} display={{ base: 'none', md: 'flex' }}>
              <Title order={2} c="white">ChainBrawler</Title>
              <Text size="xs" c="dimmed">Blockchain RPG Arena</Text>
            </Stack>
          </Group>
