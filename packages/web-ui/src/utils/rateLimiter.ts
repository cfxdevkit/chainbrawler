...
class RateLimiter {
  ...
  constructor(maxRequests: number = 50, windowMs: number = 60000) { // 50 requests per minute
...
export const rateLimitedRead = async (_key: string, fn: () => Promise<any>, _cacheTimeout?: number) => {
