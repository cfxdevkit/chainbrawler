...
const walletConnectProjectId = (import.meta as any).env?.VITE_WALLETCONNECT_PROJECT_ID || 'b4e498515364475312f3eea4265b2180'
...
// RPC URL builders
const getAlchemyUrl = (chain: string) => alchemyApiKey ? `https://${chain}.g.alchemy.com/v2/${alchemyApiKey}` : `https://${chain}.g.alchemy.com/v2/demo`
const getInfuraUrl = (chain: string) => infuraApiKey ? `https://${chain}.infura.io/v3/${infuraApiKey}` : `https://${chain}.infura.io/v3/demo`
...
export const supportedChains = [confluxESpaceLocal, confluxESpaceTestnet, confluxESpace, mainnet, polygon, arbitrum]
