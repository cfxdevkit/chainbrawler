...
import { UXState, OperationState, CharacterData } from '../types';
...
export class StatusMessageManager {
  ...
  setOperationStatus(operationType: string, status: 'pending' | 'processing' | 'completed' | 'error', error?: string): void {
