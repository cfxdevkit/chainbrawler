...
import { CharacterData, MenuState, OperationState, PoolsData, LeaderboardData, ClaimsData } from '../types';
  ...
  describe('Pools Management', () => {
    it('should update pools data', () => {
      const pools: PoolsData = {
        prizePool: { value: 1000n, formatted: '1.0000 ETH', description: 'Prize pool', percentage: 50 },
        equipmentPool: { value: 500n, formatted: '0.5000 ETH', description: 'Equipment pool', percentage: 25 },
        gasRefundPool: { value: 300n, formatted: '0.3000 ETH', description: 'Gas refund pool', percentage: 15 },
        developerPool: { value: 200n, formatted: '0.2000 ETH', description: 'Developer pool', percentage: 10 },
        nextEpochPool: { value: 0n, formatted: '0.0000 ETH', description: 'Next epoch pool', percentage: 0 },
        emergencyPool: { value: 0n, formatted: '0.0000 ETH', description: 'Emergency pool', percentage: 0 },
        totalValue: 2000n,
